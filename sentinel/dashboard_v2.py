...
<style>
    ...
    /* Reduce Streamlit column gaps and page margins */
    .main .block-container,
    .stMainBlockContainer,
    [data-testid="stMainBlockContainer"],
    .appview-container .main .block-container {
        padding-top: 0.2rem !important; padding-left: 0.3rem !important;
        padding-right: 0.3rem !important; padding-bottom: 0.2rem !important;
        max-width: 100% !important; width: 100% !important;
    }
    [data-testid="stHorizontalBlock"] { gap: 0.3rem !important; }
    [data-testid="stVerticalBlock"] > div { padding-top: 0 !important; margin-top: 0 !important; }
    [data-testid="stVerticalBlockBorderWrapper"] { padding: 0 !important; }
    .stAppHeader, header[data-testid="stHeader"] { height: 0 !important; min-height: 0 !important; }
...
with _col_left:
    ...
    with col_score:
        ...
        _triple_html = (
            f"<table style='width:100%;border-collapse:collapse;table-layout:fixed;margin:3px 0 0 0;'>"
            f"<tr>{_tc1}{_tc3}{_tc2}</tr></table>")
        _warmed = _macro_result['assets_warmed_up']
        _total = _macro_result['total_assets_tracked']
        _conf_avg = _macro_result['confidence_avg']

        # Confluence slider (inline, no separate st.markdown)
        ...
        # Single markdown: triple cards + confluence slider
        _combined_html = _triple_html + _confl_html
        st.markdown(tt(_combined_html, '\U0001f9ea Triple Signal System',
            ...
            f"Fusi\u00f3n: <b>{_fusion['score']:.0f}</b> ({_fusion['direction']}) \u2014 Confl {_fusion['confluence_pct']:.0f}%<br><br>"
            f"{_conf_label} {_conf_pct:.0f}% | {_fusion['risk_emoji']} {_risk}",
            'down'), unsafe_allow_html=True)
