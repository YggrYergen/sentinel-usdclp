...
> 🔴 **B9 ABIERTO** (dueño: user): faltan 202603–202606 en el sustrato AVA. Hasta cerrarlo el
> sustrato AVA **no es apto para veredictos** y el **acto 2 de T0.12** (mitad AVA del holdout)
> no puede fecharse. Siguen abiertos B3 (matriz de indicadores de la autopsia) y B4 (umbrales
> operacionales de la puerta estadística), ambos del user y ninguno bloquea Fase 0.
...
| B9 | 🔴 El sustrato AVA tiene un agujero de cuatro meses: faltan **202603, 202604, 202605 y 202606** (mar-jun 2026) — el lago tiene 52 meses, no 56, la serie salta de `202602` a `202607`. No es fallo de ingesta (`filas_leidas == filas_escritas`): el CSV de origen no contiene esos meses. Importa porque el hueco está **en medio** del sustrato, cae **justo antes** de la ventana en que la 902 operó en vivo (ata A6), y cualquier backtest que lo cruce daría resultados incompletos sin avisar. Motivó **D-29**: continuidad temporal como chequeo obligatorio antes de declarar apto cualquier sustrato | Declaración de aptitud del sustrato AVA para veredictos; A6 Pata A/B; LBT | **User** — re-exportar desde el terminal AVA únicamente el tramo 2026-03-01 → 2026-06-30; la reingesta es idempotente y saltará los 52 meses ya escritos |
